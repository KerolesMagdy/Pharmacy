...
//     @Range(min = 10,max = 11, message = ConstantExceptionPhrases.phone_limit)
    ...
    @Column(name= table_users_attribute_user_id, unique=true, nullable=false)
    ...
    @Column(name= table_users_attribute_user_name, nullable=false, length=200)
    ...
    @Column(name= table_users_attribute_user_dob, length=10)
    ...
    @Column(name= table_users_attribute_user_phone, nullable=false)
    ...
    @Column(name= table_users_attribute_user_email, nullable=false, length=50)
    ...
    @Column(name= table_users_attribute_user_password, nullable=false, length=20)
    ...
    @Column(name= table_users_attribute_user_image, length=1000)
    ...
    @Column(name= table_users_attribute_user_lat, precision=12, scale=0)
    ...
    @Column(name= table_users_attribute_user_long, precision=12, scale=0)
...
@JsonBackReference(value = "user-address")
    @JoinColumn(name= table_users_attribute_address_id, nullable=false)
